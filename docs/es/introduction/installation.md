...
Nix puede instalarse de varias formas:

1. Como gestor de paquetes en macOS, Linux o WSL.
2. Como gestor del entorno del sistema en NixOS, una distribución de Linux que usa Nix
   para administrator el sistema.

Este libro se centra principalmente en el uso de NixOS y Flakes. Por eso, omitiremos el
